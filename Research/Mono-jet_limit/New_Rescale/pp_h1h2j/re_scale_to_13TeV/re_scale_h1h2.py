...
Mh1,ld345,cs,best_SR,MC_Events,N_events,r,Acc,Lum,error_S,S_obs,S_exp,cs_lim  = np.genfromtxt ("CM_atlas_1502.01518_h1h2j_new.txt",dtype=float,unpack=True,skip_header=True) 

mh1_8_cut, ld_8_cut, SR_cut, cs8TeV_cut=np.genfromtxt ("cs_8TeV_pp_h1h2j_cut.dat",dtype=float,unpack=True,skip_header=True) 
mh1_13_cut, ld_13_cut, SR_cut, cs13TeV_cut=np.genfromtxt ("cs_13TeV_pp_h1h2j_cut.dat",dtype=float,unpack=True,skip_header=True) 
...
bkg_8TeV = [Bkg8TeV_200, Bkg8TeV_200, Bkg8TeV_250, Bkg8TeV_300, Bkg8TeV_300, Bkg8TeV_300, Bkg8TeV_400, Bkg8TeV_400, Bkg8TeV_400, Bkg8TeV_400, Bkg8TeV_400]

bkg_13TeV = [Bkg13TeV_200, Bkg13TeV_200, Bkg13TeV_250, Bkg13TeV_300, Bkg13TeV_300, Bkg13TeV_300, Bkg13TeV_400, Bkg13TeV_400, Bkg13TeV_400, Bkg13TeV_400, Bkg13TeV_400]
...
plt.grid()
plt.tight_layout()
plt.savefig('Mh1_Mh2_h1h2_13TeV_new.pdf')
plt.show()
plt.clf()
