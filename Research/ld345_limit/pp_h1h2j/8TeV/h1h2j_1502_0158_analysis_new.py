...
Mh1a, cs1 = np.genfromtxt ("cs_h1h2j_8TeV_DeltaM=1_new.dat",dtype=float,unpack=True,skip_header=True) 
Mh1b, cs2 = np.genfromtxt ("cs_h1h2j_8TeV_DeltaM=100_new.dat",dtype=float,unpack=True,skip_header=True) 
...
plt.grid()
plt.tight_layout()
plt.savefig('CM_limit_h1h2_8TeV_new.pdf')
plt.clf()
