...
{   
 ...
 FILE *fdata = fopen("cs_13TeV_pp_h1h2j_maxld345.dat","w");
...
strcpy(name, "pp_h1h2j_cc" );
strcpy(batch, "./calchep_batch pp_h1h2j_cc" );
...
fprintf(f10,"Cut parameter: T(~h1,~h2)\n");
fprintf(f10,"Cut invert: False\n");
fprintf(f10,"Cut min: 400\n");
