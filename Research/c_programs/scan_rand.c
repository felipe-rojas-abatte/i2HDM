...
{  int err;
 ...
 int npoints=200000,i;
 int seed = time(NULL);
 srand(seed);
 printf("seed= %i \n",seed); 


  FILE *f1 = fopen("scan_rand_hot_zone_R1_40.dat","w"); 
 ...
 double massh1,massh2,massCH,ld345,ldm345,ld,ld45,ld3,ld4,ld5,                  	           protonSI,Omega,MDM,limit,lamS,md2,vv,cross,R,massW,massZ,alfa;
 int vstab,minvac;
 Omega=0;
 protonSI=0;
  
 double massh1_min=10,    massh1_max=80;
 double massh2_min=10,    massh2_max=40;
 double massCH_min=10,    massCH_max=40;
 double ld345_min=0,  ld345_max=0.15;
 double ld_min= 0,    ld_max=0.1;
