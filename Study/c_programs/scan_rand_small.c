...
{  int err;
 ...
 printf("seed= %i \n",seed); 
  ...
  FILE *f1 = fopen("scan_rand_small.1.dat","w"); 
 ...
 double massh1_min=10,    massh1_max=200;
 double massh2_min=10,    massh2_max=200;
 double massCH_min=10,    massCH_max=200;
 double ld345_min=-1,     ld345_max=8*PI;
