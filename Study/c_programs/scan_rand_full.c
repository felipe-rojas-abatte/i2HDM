...
{  int err;
 ...
 printf("seed= %i \n",seed); 
  ...
  FILE *f1 = fopen("scan_rand_full.dat","w"); 
 ...
 double massh1_min=10,    massh1_max=1200;
 double massh2_min=10,    massh2_max=1200;
 double massCH_min=10,    massCH_max=1200;
 double ld345_min=-8*PI,  ld345_max=8*PI;
 double ld_min= 0,        ld_max=8*PI;
