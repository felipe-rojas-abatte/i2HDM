...
MDMa, Mh1a, Mh2a, Mhca, ld345a ,lda, Omegaa, prota, Brh1a, Brh2a, Brhca, WHa, HBa, HSa, Ra, vstaba, LEPa, Sa, Ta  = np.genfromtxt("Datos/DD_ld345=1.dat",dtype=float,unpack=True,skip_header=True) 
MDMb, Mh1b, Mh2b, Mhcb, ld345b ,ldb, Omegab, protb, Brh1b, Brh2b, Brhcb, WHb, HBb, HSb, Rb, vstabb, LEPb, Sb, Tb  = np.genfromtxt("Datos/DD_ld345=0.5.dat",dtype=float,unpack=True,skip_header=True) 
MDMc, Mh1c, Mh2c, Mhcc, ld345c ,ldc, Omegac, protc, Brh1c, Brh2c, Brhcc, WHc, HBc, HSc, Rc, vstabc, LEPc, Sc, Tc  = np.genfromtxt("Datos/DD_ld345=0.2.dat",dtype=float,unpack=True,skip_header=True) 
MDMd, Mh1d, Mh2d, Mhcd, ld345d ,ldd, Omegad, protd, Brh1d, Brh2d, Brhcd, WHd, HBd, HSd, Rd, vstabd, LEPd, Sd, Td  = np.genfromtxt("Datos/DD_ld345=0.02.dat",dtype=float,unpack=True,skip_header=True) 
MDMe, Mh1e, Mh2e, Mhce, ld345e ,lde, Omegae, prote, Brh1e, Brh2e, Brhce, WHe, HBe, HSe, Re, vstabe, LEPe, Se, Te  = np.genfromtxt("Datos/DD_ld345=0.01.dat",dtype=float,unpack=True,skip_header=True) 
MDMf, Mh1f, Mh2f, Mhcf, ld345f ,ldf, Omegaf, protf, Brh1f, Brh2f, Brhcf, WHf, HBf, HSf, Rf, vstabf, LEPf, Sf, Tf  = np.genfromtxt("Datos/DD_ld345=0.001.dat",dtype=float,unpack=True,skip_header=True) 

#Read data for negatives values of ld345
MDMg, Mh1g, Mh2g, Mhcg, ld345g ,ldg, Omegag, protg, Brh1g, Brh2g, Brhcg, WHg, HBg, HSg, Rg, vstabg, LEPg, Sg, Tg  = np.genfromtxt("Datos/DD_ld345=-1.dat",dtype=float,unpack=True,skip_header=True) 
MDMh, Mh1h, Mh2h, Mhch, ld345h ,ldh, Omegah, proth, Brh1h, Brh2h, Brhch, WHh, HBh, HSh, Rh, vstabh, LEPh, Sh, Th  = np.genfromtxt("Datos/DD_ld345=-0.5.dat",dtype=float,unpack=True,skip_header=True) 
MDMi, Mh1i, Mh2i, Mhci, ld345i ,ldi, Omegai, proti, Brh1i, Brh2i, Brhci, WHi, HBi, HSi, Ri, vstabi, LEPi, Si, Ti  = np.genfromtxt("Datos/DD_ld345=-0.2.dat",dtype=float,unpack=True,skip_header=True) 
MDMj, Mh1j, Mh2j, Mhcj, ld345j ,ldj, Omegaj, protj, Brh1j, Brh2j, Brhcj, WHj, HBj, HSj, Rj, vstabj, LEPj, Sj, Tj  = np.genfromtxt("Datos/DD_ld345=-0.02.dat",dtype=float,unpack=True,skip_header=True) 
MDMk, Mh1k, Mh2k, Mhck, ld345k ,ldk, Omegak, protk, Brh1k, Brh2k, Brhck, WHk, HBk, HSk, Rk, vstabk, LEPk, Sk, Tk  = np.genfromtxt("Datos/DD_ld345=-0.01.dat",dtype=float,unpack=True,skip_header=True) 
MDMl, Mh1l, Mh2l, Mhcl, ld345l ,ldl, Omegal, protl, Brh1l, Brh2l, Brhcl, WHl, HBl, HSl, Rl, vstabl, LEPl, Sl, Tl  = np.genfromtxt("Datos/DD_ld345=-0.001.dat",dtype=float,unpack=True,skip_header=True) 
